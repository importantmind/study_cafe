...
///////////////////////////////////////////////////////////////////////////////////////			
			...
			if(num > 9 || num < 1) {
				...
				sct.getSeat().get(num-1).setSet(true);  //좌석 boolean값 바꾸기
				lc.getMember().setNum(num);		//사용자의 좌석 자리값 바꾸기
				go = false;
				return;
				//자리 선택불가
			}else{
...
////////////////////////////////////////////////////////////////////////////////////////			
			if(num > 9 || num < 1) {
				...
				lc.getMember().setNum(num);	//사용자의 좌석 넘버 선택한 넘버로 변경
				go = false;
				return;
			}else {
				//자리 선택불가
